...
public class AnalysisHelper {
  ...
  public void getMaxLikeCommentPost(){
      ...
      System.out.println("Q2 - Average number of likes per comments: " + data.getPosts().get(postId).getPostId() );
  ...
  public void getPostWithMostComments(){
      ...
      for (Post p : data.getPosts().values()){
       ...
       System.out.println("Q3 - Post with mostcomments: " + postWithMostComments.getPostId() );
  }
  ...
  public void getPassiveCommentUSer(){
       DataStore data = DataStore.getInstance();
  ...
  public void getPassiveAndActiveOveralUsers(){
        DataStore data = DataStore.getInstance();
        ...
        ArrayList<User> users = new ArrayList(data.getUsers().values());
         ...
         System.out.println("Q6 - The following users have the overall been active" );
         
         for (int i = 0; i<5; i++){
          System.out.println(users.get(i)+ ",- Overall count:" + overallNumbers.get(users.get(i).getId()));
         }
        
         System.out.println("Q7 - The following users have the overall been active" );
